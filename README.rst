...
This project interacts with SageMath's class `Polyhedra (see reference manual) <http://doc.sagemath.org/html/en/reference/discrete_geometry/index.html#polyhedral-computations>`_, and is geared towards computational geometry and optimization. It has both an educational and a research purpose.
